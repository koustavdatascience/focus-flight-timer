...
const shipped = [
  ["14 August 2026", "A clearer public field guide", "Published the About, legal-draft, feedback, changelog, guide, crawl-control, and accessibility updates that explain Waypoint in plain language."],
  ...
  ["13 August 2026", "The first Waypoint release", "Introduced the interactive flight timer, airport and city search, geographic routes, flight-duration framing, account support, and a personal solo journey history."],
] as const;

export default function Changelog() {
  return (
    <PublicPageLayout eyebrow="Development log" title={<>The flight log, <em>kept honest.</em></>} intro="A short record of real Waypoint releases. Planned ideas stay separate from what has already shipped.">
      <section className="public-panel changelog-intro"><Compass size={20} aria-hidden="true" /><p>Entries describe changes that are in the product today. Waypoint does not publish speculative release dates or feature promises here.</p></section>
      ...
      <section className="public-section public-section-tinted"><div className="section-heading"><span className="panel-label">In development</span><h2>What keeps improving.</h2></div><div className="public-panel changelog-current"><CircleDotDashed size={20} aria-hidden="true" /><div><h3>Reliability, clarity, and careful launch preparation.</h3><p>Waypoint continues to improve its accessibility, validation, and operational readiness. This is a development note, not a promise of a particular release date.</p></div></div></section>
    </PublicPageLayout>
  );
}
