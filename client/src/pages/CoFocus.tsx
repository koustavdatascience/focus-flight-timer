...
export default function CoFocus() {
  ...
  return <main className="journey-page cofocus-page">
    <header className="journey-header"><button className="journey-back-button" onClick={() => navigate("/")}><ArrowLeft size={17} /> Flight planner</button><div className="journey-wordmark">FocusFlight</div><button className="journey-signout" onClick={() => void signOut()}>Sign out</button></header>
